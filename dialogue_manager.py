#There might be a 0 that i'm missing inthe last function return statement. 
...
class ThreadRanker(object):
    ...
    def __load_embeddings_by_tag(self, tag_name):
        embeddings_path = os.path.join(self.thread_embeddings_folder, str(tag_name) + ".pkl")
    ...
    def get_best_thread(self, question, tag_name):
        ...
        question_vec = question_vec[np.newaxis,:]
